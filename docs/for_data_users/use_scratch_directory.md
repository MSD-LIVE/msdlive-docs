...
## How to Copy Files to Scratch

To copy your processed/subsetted files to the scratch dir from within your notebook:
...
Once you've copied files to your scratch directory, you can download them to your local machine or a remote computer using the MSD-LIVE CLI. See [Download Notebook Results](download_notebook_results.md) for instructions.
