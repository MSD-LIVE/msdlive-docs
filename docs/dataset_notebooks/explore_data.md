"Explore Data in Notebooks" (current - keep overview and AI Assistant)
"Reference: Working with Data" (new - dependencies + DATA_DIR + accessing multiple datasets)

# Explore Data in Notebooks

The fourth component of MSD-LIVE's dataset notebooks feature is the ability to run code from within Jupyter Notebooks against data mounted from a dataset. See [Exploring Datasets via Jupyter Notebooks](/dataset_notebooks/overview) for an overview of related dataset notebook features.
